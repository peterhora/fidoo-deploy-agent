...
import { startDeviceCodeFlow, pollForToken, refreshAccessToken, } from "../../src/auth/device-code.js";
...
describe("startDeviceCodeFlow", () => {
    ...
    it("throws on non-200 response", async () => {
        ...
        await assert.rejects(() => startDeviceCodeFlow(TENANT, CLIENT, SCOPE), (err) => {
...
describe("pollForToken", () => {
    ...
    it("throws on expired_token", async () => {
        ...
        await assert.rejects(() => pollForToken(TENANT, CLIENT, "DEVICE123", 0), (err) => {
...
describe("refreshAccessToken", () => {
    ...
    it("throws on failure", async () => {
        ...
        await assert.rejects(() => refreshAccessToken(TENANT, CLIENT, "old-refresh"), (err) => {
            assert.ok(err.message.includes("invalid_grant"));
            return true;
        });
    });
});
//# sourceMappingURL=device-code.test.js.map